...
export class Mid2 extends React.Component<{ routerStore?: RouterStore }> {
  renderSubcomponent() {
    ...
    switch (level) {
      case 'btm1': return <Btm1 />
      case 'btm2': return <Btm2 />
      default: return <div />
    }
  }
  render() {
    return <div>
      <h1>Mid2</h1>
      <nav>
        <ConnectedLink activeClassName="activeLink" routeName="top1.mid2.btm1">
          Btm1
        </ConnectedLink>

        <ConnectedLink activeClassName="activeLink" routeName="top1.mid2.btm2">
          Btm2
        </ConnectedLink>
      </nav>
